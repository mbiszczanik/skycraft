...
| **Public IP zones** | Zone-redundant (AVM default `availabilityZones: [1, 2, 3]`) | Non-zonal (pre-v2 raw resource); single zone | Matches the portal default for Standard SKU and the zone-redundancy story of the Standard Load Balancer in Lab 2.3, at the same price. |
