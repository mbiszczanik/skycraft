...
|---|---|---|---|
| VM SKU default | Standard_B2ls_v2 (2 vCPU, 4 GB RAM, burstable v2) | Standard_D2s_v3 (fixed performance, costlier), Standard_B1s (smaller, insufficient for game servers) | B2ls_v2 is the "sweet spot" for a lab: burstable CPU is cheap (~€30/mo), sufficient for light loads, and teaches students the "burst concept" before graduating to fixed-SKU VMs in production. |
